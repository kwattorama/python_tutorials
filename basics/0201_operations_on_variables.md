...
Operations on variables in python look like mathematical expressions with some minor differences.

**Note:** All the rules of basic mathematical properties like **[Associative property](https://en.wikipedia.org/wiki/Associative_property)**, **[Commutative property](https://en.wikipedia.org/wiki/Commutative_property)**, etc. apply in python too.

There are couple of operations that we can do on variables like **[Arithmetic operations](https://en.wikipedia.org/wiki/Arithmetic#Arithmetic_operations)**, **[Assignments operations](https://en.wikipedia.org/wiki/Augmented_assignment)**, **[Comparison operations](https://en.wikipedia.org/wiki/Relational_operator)** (Relational operations), Logical operations and Identity-Membership operations.
...
Multiplication is also **commutative** and **associative** like addition plus it is [**distributive**](https://en.wikipedia.org/wiki/Distributive_property) as well.
...
Assignment Operations are carried out using **[Augmented Assignment](https://en.wikipedia.org/wiki/Augmented_assignment)** or **Compound Assignment**.
...
**Note:** Booleans (bool) are **subclass** (child class) of **Integers** (int), hence in python **0** and **1** can also be resolved or treated as **False** and **True** respectively.
...
**Important Tip:** If both the operands are False, **second operand** will be considered as the output.
